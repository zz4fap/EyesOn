...
class Interface:
    ...
    def main(self):
        ...
        ASSETS_PATH = OUTPUT_PATH / Path(r"C:\PyProjects\EyesOn\vFinal-Artigo\MainCode\interfacev4\assets\frame0")
    ...
    def screen1(self):
        OUTPUT_PATH = Path(__file__).parent
        ASSETS_PATH = OUTPUT_PATH / Path(r"C:\PyProjects\EyesOn\vFinal-Artigo\MainCode\interfacev4\assets\frame1")
    ...
    def screen2(self):
        OUTPUT_PATH = Path(__file__).parent
        ASSETS_PATH = OUTPUT_PATH / Path(r"C:\PyProjects\EyesOn\vFinal-Artigo\MainCode\interfacev4\assets\frame2")
