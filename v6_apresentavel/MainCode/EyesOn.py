...
def main():
    ...
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\fapesp-inatel\git_\EyesOn_1\MainCode\TkDesigner Interface\build\assets\frame0")
...
def screen1():
    ...
    OUTPUT_PATH = Path(__file__).parent
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\fapesp-inatel\git_\EyesOn_1\MainCode\TkDesigner Interface\build\assets\frame1")
...
def screen2():
    ...
    OUTPUT_PATH = Path(__file__).parent
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\fapesp-inatel\git_\EyesOn_1\MainCode\TkDesigner Interface\build\assets\frame2")
