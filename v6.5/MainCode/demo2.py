...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        while True:
            ...
            #SE ESTIVER NA INTERFACE GERAL E ENTRAR PARA A INTERFACE DO GOOGLE
            #if flag_click == False and interface_google.interface_google_on == True:
            #    flag_click = True #TRUE SIGNIFICA QUE ESTÁ NA INTERFACE_GOOGLE
            #    mouse_monitor_general.stop()
            #    mouse_monitor_browser.start()

            #CASO A INTERFACE SEJA DESLIGADA, A FLAG VAI PARA FALSO
            #if flag_click == True and interface_google.interface_google_on == False:
            #    flag_click = False #FALSE SIGNIFICA QUE ESTÁ NA INTERFACE GERAL
            #   mouse_monitor_browser.stop()
            #   mouse_monitor_general.start()
