...
class GazeEvaluationThread(threading.Thread):
    ...
    def run(self):
        ...
        model_x = joblib.load('model_x_linear_morePitch_flash.pkl')
        model_y = joblib.load('model_y_linear_morePitch_flash.pkl')
...
#                y_list.append(results.yaw)
                ...
                if time.time() - new_start > 37.5: #9points
                    stop_time = True
                    with open('accuracy4s_test8-flashttt-eachPredict-24.01.csv', 'w') as f:
