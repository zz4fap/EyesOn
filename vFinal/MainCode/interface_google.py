...
def key_press(key):
    ...
    if key == "\n":
        ...
        interface_google_on = True
        pag.moveTo( (1920//4) * 4 - 230, (1080//3) * 2 + 280) #ALTERAR PARA A INTERFACE NO CANTO INFERIOR DA TELA +475 -> move
        interface2_gui()
    else:
...
def interface2_gui():
    ...
    buttons = [
        ('↑', 0, 1, lambda: send_navigation_key(Keys.PAGE_UP)),
        ('↓', 0, 2, lambda: send_navigation_key(Keys.PAGE_DOWN)),
        ('🔍', 0, 3, enter_key)
    ]
