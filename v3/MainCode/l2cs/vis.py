...
def move_cursor(results: GazeResultContainer, kb_t, calc_t):
    ...
    x, y = pag.position()
    if dx_mean < 20 and dx_mean > -30 and dy_mean < 60 and dy_mean > 20:
        center_all = True
    ...
    if kb_t or calc_t:
        ...
        px = 640
        py = 540
    if current_time - last_execution_time >= 0.4: #a cada x segundos é possível fazer um movimento com o cursor
