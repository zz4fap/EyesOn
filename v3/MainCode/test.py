...
def getArch(arch,bins):
    ...
    if arch == 'ResNet18':
        ...
        model = L2CS( torchvision.models.resnet.Bottleneck, [3, 4, 6,  3], bins) #resnet50
        #model = L2CS(torchvision.models.resnext101_32x8d, [3, 4, 23,   3], bins) #resnext 101
        #model = L2CS(torchvision.models.resnet.Bottleneck, [3, 8, 36, 3], bins) #resnet 152
        #model = L2CS( torchvision.models.resnet.BasicBlock,[2, 2,  2, 2], bins) #resnet 18
        #model = torchvision.models.vit_b_16(weights="IMAGENET1K_V1")  # Using pretrained weights on ImageNet-1K
