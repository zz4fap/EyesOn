...
def draw_gaze(a,b,c,d,image_in, pitchyaw, thickness=2, color=(255, 255, 0),scale=1.5):
    ...
    print(f"dx = {dx} /// dy = {dy}")
    #é possível fazer uma lógica de interface através de dx e dy
    ...
    #como eu posso achar as coordenadas que correspondem a cada área da tela
    #->analisar os cálculos sendo feitos e tirar conclusão
