...
def quit_application():
    root.quit()  # This function stops the main loop
    root.destroy()  # This function is necessary on Windows to fully close the window
...
def setup_gui():
    ...
    for (symbol, row, column) in buttons:
        if symbol == '=':
            ...
            btn = tk.Button(root, text=symbol, padx=40, pady=20, command=root.quit, font=("Arial", 32), fg="red")
        else:
